...
<body>
 ...
 <header class="header slider-fade thank_main" id="mainbanner">
        <div class="owl-carousel owl-theme">
            <!-- The opacity on the image is made with "data-overlay-dark="number". You can change it using the numbers 0-9. -->
            <div class="item bg-img" data-overlay-dark="7" data-background="img/thankyou.jpg">
                <div class="v-middle">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="caption">
                                    <h2>Thank you</h2>
                                    <h5>We’ve received your message — our team will get back to you within a few hours with an update.</h5> <a
                                        href="index.php" class="button-1 mt-15 mb-15">Back To Home <span
